...
@endif 
    <div class="site-section pb-0">
      ...
      <div class="container">
        ...
        <div  class="alert alert-success">
          <center>{{__('customlang.t_title')}}</center>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ml-auto align-self-start card1"  data-aos="fade-down" data-aos-delay="100">
            ...
            <div class="p-4 rounded bg-white why-choose-us-box">
              ...
              <form method="post" action="{{route('handle.travel')}}">
                @csrf
                    ...
                    <div class="light"  id="text" style="display:none;pading:20px" >
                        ...
                        <hr>
                          ...
                          <div class="col-sm-12">
                           ...
                           <select style="width:100%" name="country"  class="form-control js-example-basic-single"> 

                            <option value="" disabled selected hidden>{{__('customlang.t_country')}} </option>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
    ...
    <center>
      ...
      <p style="margin-top:10px" data-aos="fade-up" data-aos-delay="300"><a href="/medical-test" class="btn btn-success py-3 px-5 btn-pill">       {{__('customlang.back')}}</a><button type="submit" class="btn btn-primary py-3 px-5 btn-pill">     {{__('customlang.proceed')}}   </button></p>
