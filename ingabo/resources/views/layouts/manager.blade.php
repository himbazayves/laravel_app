           ...
           {{ __('Logout') }}
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('manager.vistor')}}">
                                <i class="fas fa-eye"></i>Vistors</a>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                <a href="{{route('manager.detail')}}">
                                    <i class="fas fa-eye"></i>Emergency Contacts</a>
                                </li>
                                <li>
            ...
            <section>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2020 Rurarera. All rights reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
